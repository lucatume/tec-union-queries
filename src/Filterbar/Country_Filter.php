...
use Tribe\Events\Filterbar\Views\V2\Filters\Country as Original_Filter;
use Tribe__Cache_Listener as Cache;

require_once __DIR__ . '/Venue_Attribute_Filter_Trait.php';

class Country_Filter extends Original_Filter {
	...
	protected function get_values() {
		...
		$values = $this->fetch_venue_attribute_values( '_VenueCountry' );
	...
	protected function setup_join_clause() {
		$this->setup_venue_attribute_join_clause( '_VenueCountry' );
